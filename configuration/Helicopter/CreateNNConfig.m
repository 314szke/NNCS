% Model names
model_path = 'models/Helicopter';
nominal_model_path = sprintf('%s/helicopter_nominal', model_path);
nn_model_path = sprintf('%s/helicopter_nn', model_path);
parallel_model_before_retraining_path = sprintf('%s/helicopter_parallel_before_retraining', model_path);
parallel_model_after_retraining_path = sprintf('%s/helicopter_parallel_after_retraining', model_path);
...
model_options.controller_value = 10;
model_options.gain_value = 1;
model_options.initial_condition = 0;
...
data_options.input_dimension = 2;
...
training_options.max_epochs = 20;
