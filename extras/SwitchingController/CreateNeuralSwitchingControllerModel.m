function model = CreateNeuralSwitchingControllerModel(model_path, simulation, options)
...
if isstruct(simulation) == 0
    error("CreateNeuralSwitchingControllerModel:TypeError", "The parameter 'simulation' must have type 'struct'!");
end
